...
def check_kernel_correctness(program_path: str, atol: float, rtol: float, verbose: bool):
    """
    Checks the numerical correctness of a Triton kernel file using the tb_eval library's
    ROCm evaluator.
    ...
    # Instantiate the ROCm evaluator from the tb_eval library
    try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="A script to check the numerical correctness of a Triton kernel file using the tb_eval ROCm evaluator.",
