...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.chunk_gated_attention import fwd_pre as fwd_pre_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.chunk_gated_attention import fwd_inner as fwd_inner_ref
