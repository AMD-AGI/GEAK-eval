...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.chunk_gla_fwd import chunk_fwd_intra_gated_gk_fn as chunk_fwd_intra_gated_gk_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.chunk_gla_fwd import chunk_fwd_o_gated_gk_fn as chunk_fwd_o_gated_gk_ref
