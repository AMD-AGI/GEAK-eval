...
from chunk_gla_simple import chunk_fwd_o_fn
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.chunk_gla_simple import chunk_fwd_o_fn as chunk_fwd_o_fn_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        h, q, k, v, g, BT, scale = input_tensor
        return chunk_fwd_o_fn_ref(h, q, k, v, g, BT, scale)
