...
from context_attn_nopad import context_attention_fwd
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.context_attn_nopad import context_attention_fwd as context_attention_fwd_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        ...
        context_attention_fwd_ref(q, k, v, o, b_start_loc, b_seq_len, max_input_len)
        return o
