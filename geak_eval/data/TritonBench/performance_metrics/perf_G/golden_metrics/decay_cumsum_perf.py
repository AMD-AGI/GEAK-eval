...
from decay_cumsum import launch_fwd_decay_cumsum
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.decay_cumsum import launch_fwd_decay_cumsum as launch_fwd_decay_cumsum_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        g, g_o, B, H, T, scale, BT, BK, DK = input_tensor
        launch_fwd_decay_cumsum_ref(g, g_o, B, H, T, scale, BT, BK, DK)
        return g_o
