...
from destindex_copy_kv1 import destindex_copy_kv

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.destindex_copy_kv1 import destindex_copy_kv as destindex_copy_kv_ref
