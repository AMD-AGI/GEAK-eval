...
from diag_ssm_triton import diag_ssm_forward_triton

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.diag_ssm_triton import diag_ssm_forward_triton as diag_ssm_forward_triton_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        s, x, Lambda = input_tensor
        return diag_ssm_forward_triton_ref(s, x, Lambda)
