...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.fp4_to_bf16 import triton_f4_to_bf16 as triton_f4_to_bf16_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return triton_f4_to_bf16_ref(input_tensor)
