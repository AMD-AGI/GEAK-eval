...
from fused_layernorm_triton import fused_native_layer_norm

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.fused_layernorm_triton import fused_native_layer_norm as fused_native_layer_norm_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return fused_native_layer_norm_ref(*input_tensor)
