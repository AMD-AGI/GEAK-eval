...
from fused_recurrent_retention import fused_recurrent_retention

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.fused_recurrent_retention import fused_recurrent_retention as fused_recurrent_retention_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v, initial_state = input_tensor
        return fused_recurrent_retention_ref(q, k, v, initial_state, output_final_state=True)
