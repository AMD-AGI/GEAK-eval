...
from index_select_cat import index_select_cat_fwd

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.index_select_cat import index_select_cat_fwd as index_select_cat_fwd_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        output, source, index = input_tensor
        return index_select_cat_fwd_ref(output, source, index)
