...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.int_scaled_matmul import int_scaled_matmul_kernel as int_scaled_matmul_kernel_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.int_scaled_matmul import Config as Config_ref
