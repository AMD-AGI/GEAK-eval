...
from kldiv_compute import kldivergence  # Correctly import the operator

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.kldiv_compute import kldivergence as kldivergence_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return kldivergence_ref(input_tensor[0], input_tensor[1])
