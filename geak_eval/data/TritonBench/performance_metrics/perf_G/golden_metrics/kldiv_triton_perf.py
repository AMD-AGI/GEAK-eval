...
from kldiv_triton import kldiv_forward_triton

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.kldiv_triton import kldiv_forward_triton as kldiv_forward_triton_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        y_pred, y_true = input_tensor
        return kldiv_forward_triton_ref(y_pred, y_true, log_target=False, reduction='batchmean')
