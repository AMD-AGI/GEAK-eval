...
from matmul_persistent_triton import matmul_persistent

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_persistent_triton import matmul_persistent as matmul_persistent_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        a, b = input_tensor
        return matmul_persistent_ref(a, b)
