...
from matrix_reduction import load_reduce

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matrix_reduction import load_reduce as load_reduce_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        BLOCK_M, BLOCK_N = input_tensor
        return load_reduce_ref(BLOCK_M, BLOCK_N, 'float16')
