...
from rms_norm_triton import rms_norm

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rms_norm_triton import rms_norm as rms_norm_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        x, normalized_shape, weight = input_tensor
        return rms_norm_ref(x, normalized_shape, weight)
