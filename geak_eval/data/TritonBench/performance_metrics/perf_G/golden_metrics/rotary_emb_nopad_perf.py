...
from rotary_emb_nopad import rotary_embedding

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rotary_emb_nopad import rotary_embedding as rotary_embedding_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, cos, sin = input_tensor
        rotary_embedding_ref(q, k, cos, sin)
