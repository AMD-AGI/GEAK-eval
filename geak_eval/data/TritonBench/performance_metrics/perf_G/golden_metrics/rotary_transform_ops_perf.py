...
from rotary_transform_ops import apply_rotary

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rotary_transform_ops import apply_rotary as apply_rotary_ref
