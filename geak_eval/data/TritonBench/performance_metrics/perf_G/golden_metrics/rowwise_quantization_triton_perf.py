...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rowwise_quantization_triton import quantize_rowwise as quantize_rowwise_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return quantize_rowwise_ref(input_tensor)
