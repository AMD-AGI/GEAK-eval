...
from attention_fwd_triton1 import AttentionFunction
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.attention_fwd_triton1 import AttentionFunction as AttentionFunction_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v = input_tensor
        return AttentionFunction_ref.apply(q, k, v)
