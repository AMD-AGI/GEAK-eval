...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.embedding_triton_kernel import embedding as embedding_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        input_ids, weight, vob_start_id, vob_end_id, out = input_tensor
        embedding_ref(input_ids, weight, vob_start_id, vob_end_id, out)
        return out
