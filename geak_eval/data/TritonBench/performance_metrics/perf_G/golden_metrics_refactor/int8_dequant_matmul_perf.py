...
from int8_dequant_matmul import int8_matmul_rowwise_dequantize

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.int8_dequant_matmul import int8_matmul_rowwise_dequantize as int8_matmul_rowwise_dequantize_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        a, b, state_x, state_w, bias = input_tensor
        return int8_matmul_rowwise_dequantize_ref(a, b, state_x, state_w, bias)
