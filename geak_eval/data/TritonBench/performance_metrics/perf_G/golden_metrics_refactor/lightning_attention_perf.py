...
from lightning_attention import lightning_attn2_no_decay

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.lightning_attention import lightning_attn2_no_decay as lightning_attn2_no_decay_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v = input_tensor
        return lightning_attn2_no_decay_ref(q, k, v)
