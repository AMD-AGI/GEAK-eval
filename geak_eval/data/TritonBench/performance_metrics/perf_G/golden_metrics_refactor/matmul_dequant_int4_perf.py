...
from matmul_dequant_int4 import matmul_dequantize_int4_s1, quantize_int4

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_dequant_int4 import matmul_dequantize_int4_s1 as matmul_dequantize_int4_s1_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_dequant_int4 import quantize_int4 as quantize_int4_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        a, b, b_scale, b_zero_point, group_size = input_tensor
        return matmul_dequantize_int4_s1_ref(a, b, b_scale, b_zero_point, group_size)
