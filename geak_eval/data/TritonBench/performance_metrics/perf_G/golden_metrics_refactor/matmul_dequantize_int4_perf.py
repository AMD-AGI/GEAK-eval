...
from matmul_dequantize_int4 import matmul_dequantize_int4_gptq, quantize_int4

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_dequantize_int4 import matmul_dequantize_int4_gptq as matmul_dequantize_int4_gptq_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_dequantize_int4 import quantize_int4 as quantize_int4_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        x, qweight, scales, qzeros, group_size = input_tensor
        return matmul_dequantize_int4_gptq_ref(x, qweight, scales, qzeros, group_size)
