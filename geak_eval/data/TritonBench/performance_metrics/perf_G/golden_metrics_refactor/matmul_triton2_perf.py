...
from matmul_triton2 import triton_matmul

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_triton2 import triton_matmul as triton_matmul_ref
from geak_eval.perf.performance_utils import Performance_Metrics, do_bench_config

class performance_metrics(Performance_Metrics):
    def __init__(self, dtype=None, is_backward=False, **kwargs):
        super().__init__('matmul_triton2', dtype=dtype, is_backward=is_backward, **kwargs)
