...
from mixed_sparse_attention import _triton_mixed_sparse_attention

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.mixed_sparse_attention import _triton_mixed_sparse_attention as _triton_mixed_sparse_attention_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v, seqlens, block_count, block_offset, column_count, column_index, sm_scale = input_tensor
        return _triton_mixed_sparse_attention_ref(q, k, v, seqlens, block_count, block_offset, column_count, column_index, sm_scale)
