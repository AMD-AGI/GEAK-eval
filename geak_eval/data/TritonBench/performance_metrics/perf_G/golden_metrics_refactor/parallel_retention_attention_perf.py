...
from parallel_retention_attention import parallel_retention

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.parallel_retention_attention import parallel_retention as parallel_retention_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v = input_tensor
        return parallel_retention_ref(q, k, v)
