...
from rmsnorm_triton import rmsnorm_triton_wrapper

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rmsnorm_triton import rmsnorm_triton_wrapper as rmsnorm_triton_wrapper_ref
