...
from rope_embedding import _rope_embedding_forward_impl

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rope_embedding import _rope_embedding_forward_impl as _rope_embedding_forward_impl_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        Q, cos, sin = input_tensor
        return _rope_embedding_forward_impl_ref(Q, cos, sin)
