...
from rope_transform import rope_forward

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rope_transform import rope_forward as rope_forward_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, cos, sin = input_tensor
        return rope_forward_ref(q, k, cos, sin)
