...
from triton_conv2d_fwd import conv2d_forward

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.triton_conv2d_fwd import conv2d_forward as conv2d_forward_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return conv2d_forward_ref(*input_tensor)
