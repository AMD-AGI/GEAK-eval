...
from attention_llama import triton_fa
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.attention_llama import triton_fa as triton_fa_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v, sm_scale, is_causal, start_position = input_tensor
        return triton_fa_ref(q, k, v, sm_scale, is_causal, start_position)
