...
from bmm_chunk_fwd import _bmm_chunk_fwd
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.bmm_chunk_fwd import _bmm_chunk_fwd as _bmm_chunk_fwd_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        a, b, chunk_size = input_tensor
        return _bmm_chunk_fwd_ref(a, b, chunk_size)
