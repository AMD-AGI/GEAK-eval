...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.cross_entropy2 import cross_entropy_fwd as cross_entropy_fwd_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.cross_entropy2 import cross_entropy_bwd as cross_entropy_bwd_ref
