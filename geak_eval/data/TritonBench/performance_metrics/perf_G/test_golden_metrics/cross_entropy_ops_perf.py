...
from cross_entropy_ops import cross_entropy_loss
...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.cross_entropy_ops import cross_entropy_loss as cross_entropy_loss_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        ...
        return cross_entropy_loss_ref(logits, labels)
