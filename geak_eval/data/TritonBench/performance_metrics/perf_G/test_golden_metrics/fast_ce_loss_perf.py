...
from fast_ce_loss import fast_cross_entropy_loss

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.fast_ce_loss import fast_cross_entropy_loss as fast_cross_entropy_loss_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        logits, labels = input_tensor
        return fast_cross_entropy_loss_ref(logits, labels)
