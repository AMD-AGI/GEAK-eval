...
from fused_recurrent_delta import fused_recurrent_delta_rule

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.fused_recurrent_delta import fused_recurrent_delta_rule as fused_recurrent_delta_rule_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        q, k, v, beta = input_tensor
        return fused_recurrent_delta_rule_ref(q, k, v, beta)
