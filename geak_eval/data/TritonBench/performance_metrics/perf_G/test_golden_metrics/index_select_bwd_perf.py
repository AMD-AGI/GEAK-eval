...
from index_select_bwd import index_select_cat_bwd

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.index_select_bwd import index_select_cat_bwd as index_select_cat_bwd_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        grad_source, index, grad_output = input_tensor
        index_select_cat_bwd_ref(grad_source, index, grad_output)
