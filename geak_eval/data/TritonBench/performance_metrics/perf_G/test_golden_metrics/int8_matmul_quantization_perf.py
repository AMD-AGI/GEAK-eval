...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.int8_matmul_quantization import matmul_quantize_int8 as matmul_quantize_int8_ref
from geak_eval.data.TritonBench.data.TritonBench_G_v1.int8_matmul_quantization import quantize_int8 as quantize_int8_ref
