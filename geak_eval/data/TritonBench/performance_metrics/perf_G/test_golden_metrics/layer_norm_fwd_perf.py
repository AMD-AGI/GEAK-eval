...
from layer_norm_fwd import _layer_norm_fwd

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.layer_norm_fwd import _layer_norm_fwd as _layer_norm_fwd_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        x, weight, bias = input_tensor
        eps = 1e-5
        return _layer_norm_fwd_ref(x, weight, bias, eps)
