...
from layer_norm_ops import _layer_norm_fwd

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.layer_norm_ops import _layer_norm_fwd as _layer_norm_fwd_ref
