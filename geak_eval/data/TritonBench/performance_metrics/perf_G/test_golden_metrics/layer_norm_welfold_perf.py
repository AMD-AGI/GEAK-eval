...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.layer_norm_welfold import fused_native_layer_norm_no_welford as fused_native_layer_norm_no_welford_ref
