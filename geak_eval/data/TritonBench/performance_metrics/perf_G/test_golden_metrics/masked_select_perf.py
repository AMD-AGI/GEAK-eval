...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.masked_select import masked_select as masked_select_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return masked_select_ref(input_tensor[0], input_tensor[1])
