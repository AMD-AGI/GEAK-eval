...
from matmul_leakyrelu_fp8 import matmul  # Correctly import the matmul function

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matmul_leakyrelu_fp8 import matmul as matmul_ref
