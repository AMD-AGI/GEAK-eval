...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.matrix_transpose import wrapper as wrapper_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return wrapper_ref(input_tensor.size(0), input_tensor.size(1))
