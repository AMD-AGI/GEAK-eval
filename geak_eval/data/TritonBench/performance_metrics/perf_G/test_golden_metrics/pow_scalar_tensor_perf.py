...
from geak_eval.data.TritonBench.data.TritonBench_G_v1.pow_scalar_tensor import pow_func_scalar_tensor_wrapper_rank_1 as pow_func_scalar_tensor_wrapper_rank_1_ref
