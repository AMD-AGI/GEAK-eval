...
from quantize_kv_transform import destindex_copy_quantize_kv

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.quantize_kv_transform import destindex_copy_quantize_kv as destindex_copy_quantize_kv_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        K, DestLoc, Out, Out_scale = input_tensor
        destindex_copy_quantize_kv_ref(K, DestLoc, Out, Out_scale)
        return Out, Out_scale
