...
from rbe_triton_transform import rbe_triton_wrapper

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rbe_triton_transform import rbe_triton_wrapper as rbe_triton_wrapper_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        pos = 0  # Example starting position
        return rbe_triton_wrapper_ref(input_tensor, pos)
