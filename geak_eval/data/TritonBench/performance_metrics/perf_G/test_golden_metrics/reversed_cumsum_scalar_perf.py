...
from reversed_cumsum_scalar import chunk_global_reversed_cumsum_scalar

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.reversed_cumsum_scalar import chunk_global_reversed_cumsum_scalar as chunk_global_reversed_cumsum_scalar_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        return chunk_global_reversed_cumsum_scalar_ref(input_tensor)
