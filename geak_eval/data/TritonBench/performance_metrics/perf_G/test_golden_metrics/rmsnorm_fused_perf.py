...
from rmsnorm_fused import TritonLlamaRMSNorm

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rmsnorm_fused import TritonLlamaRMSNorm as TritonLlamaRMSNorm_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        x, weight = input_tensor
        norm_layer = TritonLlamaRMSNorm_ref(weight)
        return norm_layer(x)
