...
from rmsnorm_implementation import rmsnorm_wrapper

import torch
import triton
import triton.language as tl
from geak_eval.data.TritonBench.data.TritonBench_G_v1.rmsnorm_implementation import rmsnorm_wrapper as rmsnorm_wrapper_ref
...
class performance_metrics(Performance_Metrics):
    ...
    def call_op_ref(self, input_tensor):
        x, rms_weights = input_tensor
        return rmsnorm_wrapper_ref(x, rms_weights)
