...
@pytest.mark.parametrize("dtype_str", ['float16']) #['int32', 'float16', 'float32', 'bfloat16'])
...
FLIP_DTYPES_FOR_PERF = ['float16'] #['int32', 'float16', 'float32', 'bfloat16'] 
FLIP_NUM_WARPS_FOR_PERF = [1] #[1, 2, 4] 
