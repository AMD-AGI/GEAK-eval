...
from tb_eval.data.TritonBench.data.TritonBench_G_v1.int4_matmul import matmul_dequantize_int4_s2 as matmul_dequantize_int4_s2_ref
from tb_eval.data.TritonBench.data.TritonBench_G_v1.int4_matmul import quantize_int4 as quantize_int4_ref
