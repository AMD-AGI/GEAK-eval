...
from tb_eval.data.TritonBench.data.TritonBench_G_v1.reversed_cumsum_scalar import chunk_global_reversed_cumsum_scalar as chunk_global_reversed_cumsum_scalar_ref
